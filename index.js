...
// const codeNames=["Cucumber","Red Apples","BeefSteak Tomatoes","Bannanas","American Parsley"];
//TODo inset image url for each code
//const imgUrl=["Images/babyCucumbers.jpg","Images/redApples.jpg","Images/BeefSteak.jpg","Images/bannanas.jpg","Images/americanParsley.jpg"];
...
let tempString=codes[x].toString().substring(0,2);
...
//display image for the chosen code
image.src="Images/"+imgUrl[x];
imageText.textContent=codeNames[x];
//print values close to the right answer
btn1.textContent=`${tempArray[0]}`;
btn2.textContent=`${tempArray[1]}`;
btn3.textContent=`${tempArray[2]}`;
btn4.textContent=`${tempArray[3]}`;
...
btn1.addEventListener("click",function(){
      ...
      if((tempRand+1) == 1){
        ...
        btn1.style.background="#00FF00";
        location.reload();
      }else{
          
        btn1.style.background="#FF0000";
      }
...
btn4.addEventListener("click",function(){
    ...
    if((tempRand+1) == 4){
      ...
      btn4.style.background="#00FF00";
      location.reload();
    }else{
        
      btn4.style.background="#FF0000";
    }
